package io.pivotal.cf.demo.web;
...
import io.pivotal.cf.demo.repo.AttendeeRepository;

@Controller
public class CloudFoundryDemoController {

	private static final Logger logger = LoggerFactory.getLogger(CloudFoundryDemoController.class);
	...
	public String addAttendee(@RequestParam("firstName") String firstName, @RequestParam("lastName") String lastName,
		...
		attendee.setId(java.util.UUID.randomUUID().toString());
